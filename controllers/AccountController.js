...
class AccountController extends RootController {
    ...
    async generateToken(userName = userList.mainUser.userName, userPassword = userList.mainUser.password) {
    ...
    async getUserId(userName = userList.mainUser.userName, userPassword = userList.mainUser.password) {
